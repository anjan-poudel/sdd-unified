## Task
Please  use this (sdd-unified) project  to create plan for a new framework `ai-sdd`.
this includes creating PRD doc, Plan doc and tasks docs  ( similar to spec=kit ).
`ai-sdd` will provide a flexible framework to run agentic software engineering team tasks and projects.
This will provide a flexible backbone and provide helpful examples to get started

### Output location (mandatory)
- Write all generated artifacts under `specs/ai-sdd-codex/` only.task
