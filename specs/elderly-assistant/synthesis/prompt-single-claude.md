...
| Score | Routing |
|---|---|
| 85–100 | Proceed to next phase |
| 70–84 | Conditional proceed — gaps logged, `QA` notified |
| 50–69 | Reroute — research or revise before resubmitting |
| 0–49 | Hard stop — escalate to human decision point |

If phase average < 85 and iteration count < 3: rework and resubmit.
If iteration count = 3: halt and trigger Human-in-the-Loop (HIL) gate.
