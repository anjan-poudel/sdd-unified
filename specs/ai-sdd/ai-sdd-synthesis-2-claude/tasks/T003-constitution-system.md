...
- **AUTO-GENERATED section** (`## Workflow Artifacts`): engine-written post-task; lives in project root only — never merged into sub-module constitutions.
- **User-authored section** (`## Reading Convention`): static content; merged as-is from root; never overwritten or generated by the engine.
